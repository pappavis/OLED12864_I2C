...
namespace OLED12864_I2C {
     ...
     */
    //% blockId="OLED12864_I2C_PIXEL" block="instellen pixel op x %x|y %y|kleur %color"
     ...
     */
    //% blockId="OLED12864_I2C_SHOWSTRING" block="schrijf tekst op x %x|y %y|tekst %s|kleur %color"
     ...
     */
    //% blockId="OLED12864_I2C_NUMBER" block="toon Getal op x %x|y %y|getal %num|kleur %color"
    //% weight=80 blockGap=8
    //% parts=OLED12864_I2C trackArgs=0
     ...
     */
    //% blockId="OLED12864_I2C_HLINE" block="teken horizontaal lijn op x %x|y %y|lengte %len|kleur %color"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_VLINE" block="teken verticale lijn van x %x|y %y|lengte %len|kleur %color"
     ...
     * @param color is line color, eg: 1
     */
    //% blockId="OLED12864_I2C_RECT" block="teken vierkant x1 %x1|y1 %y1|x2 %x2|y2 %y2|kleur %color"
     ...
     */
    //% blockId="OLED12864_I2C_INVERT" block="omwissel scherm achtergrond %d"
     ...
     * draw / redraw screen
     */
    //% blockId="OLED12864_I2C_DRAW" block="tekenen"
     ...
     * turn on screen
     */
    //% blockId="OLED12864_I2C_ON" block="scherm aan"
     ...
     * turn off screen
     */
    //% blockId="OLED12864_I2C_OFF" block="scherm uit"
     ...
     */
    //% blockId="OLED12864_I2C_ZOOM" block="inzoomen %d"
     ...
     */
    //% blockId="OLED12864_I2C_init" block="init OLED met I2C addr %addr"
